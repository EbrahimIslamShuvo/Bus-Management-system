      ...
      <div class="md:shadow-lg fixed w-full top-0 z-10 left-0">
        <nav class="bg-[#3FC495]">
          <div class="md:flex md:justify-around md:items-center">
            <a
              href="index.php"
              class="w-40 h-20 flex flex-col justify-center items-center"
            >
...
<section>
    <div class="pb-10 mt-20 bg-[#eaf9e7]">
        ...
        <div>
          ...
          <p class="text-center sm:px-0 px-4 text-gray-500 py-3">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Numquam, similique nesciunt sequi est voluptates totam.</p>
          <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-4 md:mx-28 mx-[5%] pt-8">
            <div class="flex flex-col border-none rounded-lg bg-[#188a62] lg:items-center">
              <img class="rounded-t-lg" src="https://i.ibb.co/ky9SN5b/tour.jpg" alt="family tour photo" />
              <p class="py-3 text-center text-white text-xl">
                First tickets for 
                <span class="font-bold text-[#dc654d]"> 10%</span> discount
              </p>
            </div>
            <div class="flex flex-col border-none rounded-lg bg-[#188a62] lg:items-center ">
              <img class="rounded-t-lg" src="https://i.ibb.co/Ss5YjfG/booking.jpg
              " alt="Booking tickets" />
              <p class="py-3 text-center text-white text-xl">
                Easy to booking
              </p>
        ...
        <div>
          ...
          <div class="bg-[#188a62] flex items-center justify-center">
            <div class="lg:flex lg:flex-row grid md:grid-cols-2 grid-cols-1 gap-y-10 md:gap-y-0 md:gap-x-20 py-2 items-center justify-center w-10/12">
              <div class="flex md:mt-0 mt-3 items-center justify-center">
                <img
                  class="w-[90px] h-[90px]"
                  src="https://i.ibb.co/LvdgwZX/tickets-sold.png"
                  alt="sold tickets"
                />
                <div>
              ...
              <div class="flex gap-x-5 items-center justify-center">
                <img
                  class="w-[90px] h-[90px]"
                  src="https://i.ibb.co/pj9DV1Q/route.png"
                  alt="sold tickets"
                />
                <div>
                  <p class="text-white font-semibold text-3xl flex items-center justify-center">
              ...
              <div class="flex gap-x-5 items-center justify-center">
                <img
                  class="w-[90px] h-[90px]"
                  src="https://i.ibb.co/5M0rnWW/happy-Client.png"
                  alt="sold tickets"
                />
                <div>
                  <p class="text-white font-semibold text-3xl flex items-center justify-center">
    ...
    <section>
        <div class="flex flex-col w-full h-full"> 
            <div style="background-image: url('https://i.ibb.co/R4GY4rb/footer.jpg');" class="bg-cover bg-no-repeat bg-center h-[700px] text-center">
              <div class="flex flex-col justify-center items-center md:w-full h-full">
                ...
                <p class="pb-3 text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa sapiente labore, eius est architecto eos!</p>
                <div class="md:w-11/12 sm:bg-white md:h-10 flex sm:flex-row flex-col sm:justify-center sm:items-center md:py-6 md:px-1 sm:border-2 sm:border-red-300 sm:rounded-full sm:overflow-hidden">
                  <input type="text" placeholder="Enter your email" class="sm:border-none rounded focus:outline-none w-full h-10 ps-5 text-black" name="subscribe" id="subscribe" />
                  <button class="bg-red-500 hover:text-black duration-300 text-lg rounded-full font-semibold px-3 py-2 sm:mt-0 mt-4">Subscribe</button>
                </div>
                </div>
              </div>
            </div>
           ...
           <div class="lg:flex md:grid md:grid-cols-2 justify-around items-center py-20 px-11">
              <div class="flex flex-col gap-y-6 justify-center md:mr-16 lg:w-[30%]">
                ...
                <p class="text-white text-lg font-mono w-full text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur labore ea alias sunt voluptate quaerat, quia facilis, magnam rerum saepe id ducimus quibusdam doloremque dignissimos! Expedita voluptatum quae possimus doloremque.</p>
              </div>
              ...
              <div class="flex flex-col justify-center lg:mt-0 mt-5">
                <h1 class="text-2xl text-white underline decoration-white decoreation-1.5 mb-3">Quick Link</h1>
                  ...
                  <div class="flex flex-col gap-y-3 mb-3 md:mb-0">
                    <a href="/about" class="text-xl text-white underline hover:text-black transition-all duration-200 hover:decoration-black decoration-white decoration-1.5">About</a>
                    <a href="/about" class="text-xl text-white underline hover:text-black transition-all duration-200 hover:decoration-black decoration-white decoration-1.5">Cookie Policy</a>
                    <a href="/about" class="text-xl text-white underline hover:text-black transition-all duration-200 hover:decoration-black decoration-white decoration-1.5">Booking Policy</a>
                    <a href="/about" class="text-xl text-white underline hover:text-black transition-all duration-200 hover:decoration-black decoration-white decoration-1.5">Contact Us</a>
                  </div>
                  <div class="flex flex-col gap-y-3">
                    <a href="/about" class="text-xl text-white underline hover:text-black transition-all duration-200 hover:decoration-black decoration-white decoration-1.5">Privacy Policy</a>
                    <a href="/about" class="text-xl text-white underline hover:text-black transition-all duration-200 hover:decoration-black decoration-white decoration-1.5">Treams and conditon</a>
                    <a href="/about" class="text-xl text-white underline hover:text-black transition-all duration-200 hover:decoration-black decoration-white decoration-1.5">My Account</a>
                  </div>
                  </div>
                  <div class="flex justify-center items-center gap-5 md:gap-20 mt-6">
                    <div class="text-black text-xl bg-white px-3 py-1 hover:text-[#188A62] hover:bg-black shadow-md shadow-gray-300 transition-all ease-in duration-300 rounded-full">
                      <a href="https://www.facebook.com">
                        <i class="fa-brands fa-facebook-f"></i>
                      </a>
                    </div>
                    <div class="text-black text-xl bg-white p-2 hover:text-[#188A62] hover:bg-black shadow-md shadow-gray-300 px-3 py-1 transition-all ease-in duration-300 rounded-full">
            ...
            <div class="flex md:flex-row flex-col justify-between items-center mx-20">
              ...
              <div class="flex justify-center items-center gap-x-4">
                  ...
                  <img class="w-12 h-10" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSl_0ydm5a7qKD1uwWZWV-jLzsvt3kS6ZC2xQ2qtFJxTw&s" alt="nogod logo" />
