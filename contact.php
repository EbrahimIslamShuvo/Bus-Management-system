...
<html lang="en">
  ...
  <body>
    ...
    <!-- <div class="container" >
       ...
       <form action="\bus\Contract US\contect.php" method="POST">
            <h1>Contract Us</h1>
   ...
   <div class="flex  flex-col w-full h-full ">
    <div class="bg-cover bg-no-repeat bg-center h-screen mt-20"  style="background-image: url('https://i.ibb.co/R4GY4rb/footer.jpg')">
        <div class="container">
          <form action="\bus\Contract US\contect.php" method="POST">
            <h1>Contract Us</h1>
            <h6>Thank you for reaching us! We are always happy to hear from you</h6>
