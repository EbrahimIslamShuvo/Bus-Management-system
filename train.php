...
<html lang="en">
  <head>
    ...
    <script
      src="https://kit.fontawesome.com/44c48dbaca.js"
  ...
  <body>
        ...
        <nav class="bg-[#3FC495]">
          <div class="md:flex md:justify-around md:items-center">
            ...
            >
              <img
                class="h-auto"
                src="https://i.ibb.co/1KWBVYx/navlogo.png"
                alt="nav image"
              />
            </a>
            <div>
    ...
    <section>
      <div class="mt-20 w-full bg-[#eaf9e7]">
        <div class="text-5xl text-center my-3">add bg image about train</div>
        <div>
          ...
          <div class="flex items-center justify-center">
            <form
              class="my-20 w-full flex flex-col gap-5 items-center justify-center"
            >
              <div
                class="flex sm:flex-row flex-col w-full sm:w-3/4 lg:w-2/4 items-center justify-center gap-5"
              >
                <div
                  class="flex flex-col items-start gap-y-1 justify-center w-3/4 sm:w-1/2"
                >
                ...
                <div
                  class="flex flex-col items-start gap-y-1 justify-center w-3/4 sm:w-1/2"
                >
                  <label html="to" class="text-xl font-roboto font-semibold"
                    >To</label
                  >
                  <input
                    type="text"
              ...
              <div
                class="flex sm:flex-row flex-col lg:w-2/4 w-full sm:w-3/4 items-center justify-center gap-5"
              >
                <div
                  class="flex flex-col items-start gap-y-1 justify-center w-3/4 sm:w-1/2"
                >
                  <label
                    ...
                    class="text-xl font-roboto font-semibold"
              ...
              >
                <input
                  class="text-white text-xl font-semibold transition-all ease-in-out cursor-pointer"
                  type="submit"
                  value="Search"
                />
              </div>
    ...
    <section>
      <div class="flex flex-col w-full h-full">
        ...
        >
          <div
            class="flex flex-col justify-center items-center md:w-full h-full"
          >
            <div
              class="bg-[#3fc495] rounded-lg px-10 py-6 mx-7 lg:m-0 lg:px-16 lg:py-10 text-white"
            >
              <h1
                class="md:text-5xl text-3xl font-semibold md:pb-0 pb-3 md:leading-loose"
              >
        ...
        <div class="bg-[#188A62] pb-5">
          <div
            class="lg:flex md:grid md:grid-cols-2 justify-around items-center py-20 px-11"
          >
            <div
              class="flex flex-col gap-y-6 justify-center md:mr-16 lg:w-[30%]"
            >
            ...
            <div
              class="md:mr-0 md:mt-0 mt-5 mr-9 flex flex-col justify-center gap-y-6"
            >
              <div class="flex flex-col justify-center">
                ...
                <div>
                  <p
                    class="text-white text-xl underline decoration-white decoration-1.5"
                  >
                    info@ur.com
                  </p>
                </div>
            ...
            <div class="flex flex-col justify-center lg:mt-0 mt-5">
              <h1
                class="text-2xl text-white underline decoration-white decoreation-1.5 mb-3"
              >
                Quick Link
              </h1>
              <div class="md:flex items-center gap-x-10">
                <div class="flex flex-col gap-y-3 mb-3 md:mb-0">
                  <a
                    href="/about"
                    class="text-xl text-white underline hover:text-black transition-all duration-200 hover:decoration-black decoration-white decoration-1.5"
                    >About</a
                  >
                  <a
                    href="/about"
              ...
              <div
                class="flex justify-center items-center gap-5 md:gap-20 mt-6"
              >
                <div
          ...
          <div
            class="flex md:flex-row flex-col justify-between items-center mx-20"
          >
            ...
            <div class="flex justify-center items-center gap-x-4">
              <img
                class="w-12 h-10"
                src="https://i.ibb.co/dPV1Nrz/visa.jpg"
                alt="rocket logo"
              />
              <img
                class="w-12 h-10"
                src="https://i.ibb.co/84cFppJ/rocket.png"
                alt="rocket logo"
              />
              <img
                class="w-12 h-10"
              ...
              <img
                class="w-12 h-10"
                src="https://i.ibb.co/QpxdXwQ/bkash.jpg"
                alt="bkash"
              />
            </div>
          </div>
